...
//     required this.selectedAvailableDays, required String selectedCategoryLabel,
...
//     'Category', 'Role', 'Skills', 'Companies', 'Location', 'Price', 'Work Experience', 'Language', 'Available Days'
//   ];
//
...
//     'Companies': [],
//     'Location': [
//       'Agra', 'Ahmedabad', 'Ajmer', 'Akola', 'Aligarh', 'Allahabad', 'Amritsar', 'Asansol', 'Aurangabad',
//       'Bangalore', 'Belgaum', 'Bhiwandi', 'Bhilai Nagar', 'Bhopal', 'Bhubaneswar', 'Bikaner',
//       'Chandigarh', 'Chennai', 'Cuttack',
//       'Dehradun', 'Delhi', 'Dhanbad',
//       'Faridabad',
//       'Ghaziabad', 'Gulbarga', 'Guntur', 'Gurgaon', 'Guwahati', 'Gwalior',
//       'Howrah', 'Hubli-Dharwad', 'Hyderabad',
//       'Indore',
//       'Jabalpur', 'Jaipur', 'Jalandhar', 'Jamnagar', 'Jamshedpur', 'Jodhpur',
//       'Kalyan-Dombivli', 'Kanpur', 'Kochi', 'Kolkata', 'Kolhapur', 'Kota',
//       'Lucknow', 'Ludhiana',
//       'Madurai', 'Mangalore', 'Meerut', 'Moradabad',
//       'Mumbai',
...
//     'Work Experience': [],
//     'Language': [
//       'English', 'Hindi', 'Bengali', 'Telugu', 'Marathi', 'Tamil', 'Gujarati', 'Urdu', 'Kannada', 'Odia', 'Punjabi',
//     ],
//     'Available Days': [
...
//   void initState() {
//     super.initState();
//     // _showSubcategories(widget.selectedCategoryLabel);
//
...
//
//
//   void _showSubcategories(String selectedCategoryLabel) {
//     setState(() {
//       filteredSubcategories = subcategories[selectedCategoryLabel]!;
//       categorySelections = selectedSubcategories[selectedCategoryLabel]!;
//       isCategorySelected = true;
//       currentCategory = selectedCategoryLabel;
//     });
//     debugPrint("currentCategory...$filteredSubcategories.length");
//   }
//
...
class _CategoryFilterScreenState extends State<CategoryFilterScreen> {
  final List<String> categories = [
    'Role', 'Skills', 'Companies', 'Location', 'Price', 'Work Experience', 'Language', 'Available Days'
  ];
  ...
  //     // Call categoryFetch after fetching the category data and initializing selectedSubcategories
  //     categoryFetch();
  //     // Automatically show the subcategories for the selected category
  //     _showSubcategories(widget.selectedCategory);
  //   });
  //   _fetchRolesFromFirestore();
  //   _fetchSkillsFromFirestore();
  //   fetchCompanyData();
  ...
  //   setState(() {
  //     filteredSubcategories = subcategories[category]!;
  //     categorySelections = Map.from(selectedSubcategories[category]!);
  //     isCategorySelected = true;
  //     currentCategory = category;
  //   });
  //   debugPrint("currentCategory...${filteredSubcategories.length}");
  ...
  //     categorySelections = {
  //       ...categorySelections,
  //       ...Map.from(selectedSubcategories[category]!),
  //     };
  //     isCategorySelected = true;
  //     currentCategory = category;
  //   });
  ...
  void _showSubcategories(String category) {
    setState(() {
      ...
      categorySelections = {
        ...categorySelections,
        ...Map.fromEntries(selectedSubcategories[category]!.entries.where((entry) => entry.value)),
      };
      isCategorySelected = true;
      currentCategory = category;
    });
                                  ...
                                  Checkbox(
                                    ...
                                    onChanged: (value) {
                                      setState(() {
                                        ...
                                        selectedSubcategories[currentCategory]![subcategory] = value ?? false;
                                      });
                                    },
                                  ),
