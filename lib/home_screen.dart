...
class _CategoryFilterScreenState extends State<CategoryFilterScreen> {
  ...
  Map<String, List<String>> subcategories = {
    ...
    'Companies': [],
    'Location': [
      'Agra', 'Ahmedabad', 'Ahmedabad', 'Ajmer', 'Akola', 'Aligarh', 'Allahabad', 'Amravati',
      'Amravati', 'Amritsar', 'Amroha', 'Asansol', 'Aurangabad', 'Bangalore', 'Belgaum', 'Bhiwandi',
      'Bhilai Nagar', 'Bhopal', 'Bhubaneswar', 'Bikaner', 'Chandigarh', 'Chennai', 'Cuttack', 'Dehradun',
      'Delhi', 'Delhi', 'Dhanbad', 'Durgapur', 'Faridabad', 'Firozabad', 'Ghaziabad', 'Gulbarga', 'Guntur',
      'Gurgaon', 'Guwahati', 'Gwalior', 'Howrah', 'Hubli-Dharwad', 'Hyderabad', 'Indore', 'Jabalpur', 'Jaipur',
      'Jalandhar', 'Jammu', 'Jamnagar', 'Jamshedpur', 'Jhansi', 'Jodhpur', 'Kalyan-Dombivli', 'Kanpur', 'Kochi',
      'Kolkata', 'Kolkata', 'Kolhapur', 'Kota', 'Kozhikode', 'Lucknow', 'Ludhiana', 'Madurai', 'Malappuram',
      'Mangalore', 'Meerut', 'Moradabad', 'Mumbai', 'Nagpur', 'Nanded', 'Nanded-Waghala', 'Nashik', 'Nellore',
      'Noida', 'Patna', 'Pimpri-Chinchwad', 'Pune', 'Pune', 'Rajahmundry', 'Rajkot', 'Ranchi', 'Ranchi', 'Ratlam',
      'Raurkela', 'Saharanpur', 'Salem', 'Sangli', 'Siliguri', 'Solapur', 'Srinagar', 'Srinagar', 'Surat', 'Thane',
      'Thiruvananthapuram', 'Tiruchirappalli', 'Ulhasnagar', 'Ujjain', 'Udaipur', 'Umarkot', 'Vadodara', 'Varanasi',
      'Vasai-Virar', 'Vellore', 'Vijayawada', 'Visakhapatnam', 'Warangal', 'Yol'
    ],
    'Price': [],
    'Work Experience': [],
    'Language': [
